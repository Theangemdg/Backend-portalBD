<?php
    ...
    switch($_SERVER['REQUEST_METHOD']){
        case 'POST':
            ...
            $producto = new Producto($_POST["id"], $_POST["nombreProducto"], $_POST["imgProducto"], $_POST["descripcion"], $_POST["precio"]);
        ...
        case 'PUT':
            ...
            $producto = new Producto($_PUT["id"], $_PUT["nombreProducto"], $_PUT["imgProducto"], $_PUT["descripcion"], $_PUT["precio"]);
